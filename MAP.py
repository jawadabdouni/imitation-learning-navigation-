...
class Map:
    ...
    def DrawMap(self):
        ...
        for k in range(1,53):
            pygame.draw.line(self.Map, bleu, (0,k*20), (1060,k*20), 1)
        for k in range(1,53):
            pygame.draw.line(self.Map, bleu,(k*20,0), (k*20,1060), 1)
        pygame.display.update()

        pygame.draw.circle(self.Map, green, (self.start[0]+10,self.start[1]+10), 8, 3)
        pygame.draw.circle(self.Map, red, (self.goal[0]+10,self.goal[1]+10), 8, 3)
